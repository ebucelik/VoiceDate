...
extension UIImageView{
    ...
    func loadImageUsingCacheWithURLString(urlImg: String)
    {
        //ImageCache damit das geladene Bild sich nicht ändert.
        if let cachedImage = imageCache.object(forKey: urlImg as NSString){
